...
data_path="/date/jc/data/Eso-Llava/processed_data/${DATA_INDEX}/v4/train.json"
image_folder="/date/jc/data/Eso-Llava/processed_data/${DATA_INDEX}/images"
output_dir="/home/jc/workspace/MedLLMs/Eso-Llava/checkpoints/${date}${version}-lora-${base_model}"
epoch=20
